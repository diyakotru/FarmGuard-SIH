...
function Icon({ children, bg = '#E6FFF8' }) {
  return (
    <div className="icon" style={{ background: bg }} aria-hidden="true">
      {children}
    </div>
  )
}

function Feature({ id, title, children, icon }) {
  return (
    <article className="feature" aria-labelledby={id}>
